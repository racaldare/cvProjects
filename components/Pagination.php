...
class Pagination
{
    ...
    public function get()
    {
        ...
        $html = '<ul class="pager" style="margin: 3% 10% 0% 10%;">';
        # Генерируем ссылки
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            # Если текущая это текущая страница, ссылки нет и добавляется класс active
            if ($page == $this->current_page) {
                $links .= '<li style="float: left; margin: 0 5px;"><a href="#" style="color: #fff; background-color: #428bca;">' . $page . '</a><div class="clr"></div></li>';
            } else {
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        return
                '<li style="float: left; margin: 0 5px;"><a href="' . $currentURI . $this->index . $page . '">' . $text . '</a><div class="clr"></div></li>';
    }
    ...
    private function amount()
    {
        ...
        # Делим и возвращаем
		 if(round(($this->total % $this->limit) == 0))
